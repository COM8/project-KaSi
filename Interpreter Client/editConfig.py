    ...
    if platform.system() == "Windows":
        try:
            ...
            ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID(
                "KiliTec.Projekt_KaSiConfigEditor.0,1")
            ...
            if downloadFile("https://drive.google.com/uc?export=download&id=0B6y6X38yrgKkcGplc2xsUDNacTglib\\icon\\icon.ico"):
                mainWindow.wm_iconbitmap(r'lib\\icon\\icon.ico')
    else:
        try:
            ...
            Kasi.createFolder("lib/icon/")
            print("Icon missing trying to downlaod it")
            if downloadFile("https://drive.google.com/uc?export=download&id=0",
